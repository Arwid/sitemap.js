 ...
 */
function SitemapIndex(urls, hostname, cacheTime, sitemapName, sitemapSize, xslUrl, gzip) {
...
SitemapIndex.prototype.toString = function () {
  var self = this;
  var sitemapUrls = self.sitemaps.map(function(sitemap, index) {
    return hostname + '/' + sitemap.filename;
  });
...
SitemapIndex.prototype.getSitemaps = function() {
